...
file generated by the RNA kinetics simulation tool I<BarMap>.

=head1 CLASSES & METHODS

This module provides several classes for working with I<BarMap>'s output. The
most relevant is L<Bio::RNA::BarMap::Mapping>, which is used to parse the
...
perform all kinds of querys on the mapping file.
...
can be queried using its methods C<is_exact()> and C<is_approx()>.

For more information, please refer to the documentation of the individual
classes.

=head1 METHODS of Bio::RNA::BarMap::Mapping
...
Returns the name of the first mapped Barriers file of this I<BarMap>
mapping.
